...
const cargarImagen = (id, nombre, ruta, descripcion) => {
    ...
    if(galeria$4.querySelectorAll('.galeria__carousel-slide').length > 0){ 
        ...
        galeria$4.querySelector('.galeria__carousel-slide--active').classList.remove
...
const slideClick = (e) => {
    ...
    // Obtenemos el id de la imagen a la que le hicieron click
    const id = parseInt(e.target.dataset.id);
    const galeria = document.getElementById('galeria');
    const categoriaActiva = galeria.dataset.categoria;     
    
    // Recorremos las fotos en busca de la foto que obtuvo el click.
